...
const FEATURES = [
  ...
  {
    title: 'Automated hours calculation',
    desc: 'Sign-in and sign-out times are recorded automatically. Hours worked are calculated to two decimal places and stored in your dashboard.',
  ...
  },
  {
    ...
    desc: 'Any laptop, tablet, or desktop with a webcam works out of the box. Mount a $60 Android tablet on the wall — instant permanent kiosk.',
  ...
  {
    title: 'Sign-out email alerts',
    desc: 'Employees who forget to sign out receive an automatic email reminder after 12 hours. Their record is flagged as incomplete in the dashboard.',
  ...
  },
  {
    ...
    desc: 'Filter by employee, date range, or department. See live sessions with elapsed time, and export any view to CSV in one click.',
  ...
  {
    title: 'Privacy-first encoding',
    desc: "Face photos are converted to a 128-number mathematical vector. The raw photo is never stored on the server. The vector can't be reversed into a photo.",
...
const TESTIMONIALS = [
  {
    quote: "We used to spend 45 minutes every Monday morning reconciling the sign-in sheet. Now the dashboard just shows us the numbers. It's genuinely magic.",
    name: 'Amaka Okonkwo',
    role: 'Office Manager',
  ...
  {
    quote: "Our security team was sceptical about face recognition, but the privacy-first approach won them over. No photos stored, just vectors. Clean.",
    name: 'Rafiq Mensah',
    role: 'IT Director',
    company: 'Silverline Group',
    avatar: 'RM',
    color: 'bg-emerald-500/20 text-emerald-300',
  },
  {
    quote: "We run a co-working space with 80+ members. FaceAttend just works — people walk in, the screen flashes green, and that's it. Zero complaints.",
    name: 'Chisom Eze',
    role: 'Community Lead',
    company: 'HubWork Lagos',
    avatar: 'CE',
  ...
  return (
    <div className="min-h-screen bg-[#050510] text-white overflow-x-hidden">
      ...
      <section className="max-w-5xl mx-auto px-6 pt-16 pb-10 text-center">
        ...
        <p className="text-xs font-semibold text-indigo-400 uppercase tracking-widest mb-4">Everything you need to know</p>
        <h1 className="text-3xl sm:text-4xl font-bold text-white mb-4 leading-tight animate-fade-in-up">
          Features, pricing & FAQ
        </h1>
        <p className="text-slate-500 text-sm max-w-md mx-auto leading-relaxed animate-fade-in-up [animation-delay:80ms]">
          A full breakdown of how FaceAttend works, what's included in each plan, and answers to the questions we get asked most.
        </p>
      </section>
