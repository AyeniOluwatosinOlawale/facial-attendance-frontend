    ...
    <div className="min-h-screen bg-[#050510] text-white overflow-x-hidden flex flex-col">
      ...
      <header className="border-b border-white/5 bg-[#050510]/80 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm text-slate-400">
            <Link to="/features#how-it-works" className="hover:text-white transition-colors">How it works</Link>
            <Link to="/features#features" className="hover:text-white transition-colors">Features</Link>
      ...
      <footer className="py-5 border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <Link to="/features" className="text-slate-700 hover:text-slate-400 text-xs transition-colors">
            Features & Pricing →
          </Link>
        </div>
      </footer>
